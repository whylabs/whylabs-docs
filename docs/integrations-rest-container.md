...
`https://your-endpoint/swagger-ui`, where `your-endpoint` is wherever you deploy the container to.
...
[Contact us](https://whylabs.ai/slack-community) to get permissions to our Docker ECR. There are many ways to run Docker containers in general so the details will depend a lot on your individual setup and requirements. We're happy to make suggestions in our slack channel if you're looking for ideas.
